...
def english_corpus():
    ...
    '''
    corpus = Corpus()
    corpus.add_words_from_link("http://norvig.com/ngrams/sowpods.txt")
    corpus.add_words_from_link("http://norvig.com/ngrams/enable1.txt")
    corpus.add_words_from_link("https://pastebin.com/raw/UegdKLq8")
    return corpus
...
class Searcher:
    ...
    def search(self, syllable: str):
        ...
        (best_word, _) = max(words, key=lambda x: get_word_ranking(x[1], self.bonus_mask))
        return best_word
